...
# Skip this check for EMSCRIPTEN cross-compilation where find_library fails
if(NOT EMSCRIPTEN)
...
if(wxWidgets_FOUND)
  # For EMSCRIPTEN, find_file may not work due to CMAKE_FIND_ROOT_PATH restrictions
  # Try to find version.h directly first
  if(EMSCRIPTEN)
    foreach(_inc_dir ${wxWidgets_INCLUDE_DIRS})
      if(EXISTS "${_inc_dir}/wx/version.h")
        set(_filename "${_inc_dir}/wx/version.h")
        break()
      endif()
    endforeach()
  else()
